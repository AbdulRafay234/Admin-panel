    ...
    <div class="form-container">
        <form class="product-form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="product-description" name="price" rows="4" required></textarea>
            </div>
            <div class="form-group">
                <label for="product-image">quantity</label>
                <input type="text" id="product-image" name="qty" accept="image/*" required>
            </div>
            <div class="form-group">
...
if(isset($_POST['btn'])){
    ...
    if($extension=="jpg" || $extension=="png" || $extension=="jpeg"){
        if(move_uploaded_file($addtmpname,$destination)){
            $q=mysqli_query($con,"INSERT INTO `product`(`product_name`, `price`, `qty`, `cat-id`, `image`) VALUES ('$addname','$price','$qty','$cat','$addimage')");
            if($q){
